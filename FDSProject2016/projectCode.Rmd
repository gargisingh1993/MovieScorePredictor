...
```{r}
paste("Looking at the MSFE values for all the three models, we can clearly see that the k-means clustering performed the worst among the three models. We can see that the linear regression model perfomed the best and second comes random forests")
