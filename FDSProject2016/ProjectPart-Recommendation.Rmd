...
correctCount <- 0
numbers <- floor(runif(1, min=0, max=130))
...
```{r}
print("We are testing our model on 25 randomly picked actors. We can see that over multiple iterations, this is how the model performs 18/25  20/25  23/25  18/25  19/25")
print( "looking at the performance of the model over multiple iterations, we can see that the model is consistently performing correctly for about 85% of the time")
```